...
> [!SUMMARY] **Newborns don’t have clear vision from day one.** Vision develops gradually over the first months of life, and what your baby sees early on is very different from adult vision.

![[how our newborn baby sees the world.png]]
## Quick Table
...
> [!SUMMARY] **White noise is generally safe for babies** and is commonly used to calm crankiness and help with sleep
...
- If _you_ have to raise your voice to talk over it → it’s too loud
**Tip:** On phones/apps, use ~25–30% volume max.
...
- You notice ear-covering or discomfort
If that happens: lower volume or try a different sound.

### Bottom line
✔ **Safe**
✔ **Helpful**
✔ **Widely recommended**
⚠️ As long as volume + distance are right


# Colicky baby

> [!SUMMARY] A **colicky baby** is an otherwise healthy infant who has **frequent, intense, and unexplained crying** that seems impossible to soothe — even though they’re fed, clean, and comfortable.
...
### ✔️ Probiotics
Some evidence supports [**Lactobacillus reuteri**](chatgpt://generic-entity?number=0) **DSM 17938** for breastfed babies
(_always check with your pediatrician first_)
...
👉 Put the baby down safely, step away, breathe,
👉 Ask for help — this is not meant to be done alone.

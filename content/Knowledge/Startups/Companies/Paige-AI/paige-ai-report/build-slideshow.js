...
// Project root - go up from current directory to find the project root
const projectRoot = path.resolve(__dirname, '../../../../../../');

// Output path for the slideshow HTML
const outputPath = path.join(projectRoot, 'quartz', 'static', 'paige-slides', 'slideshow.html');
